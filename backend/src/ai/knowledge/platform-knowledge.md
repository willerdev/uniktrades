...
- **Investor VIP** ($50/month on Invest): **10% daily** investment yield by default (vs platform standard), $0 processing fee, weekend earnings; off-schedule penalty still applies unless waived. You can **approve/send** their pending wallet withdrawals after **30 minutes** using tools when they ask (“approve my withdraw”)
