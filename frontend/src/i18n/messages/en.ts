export const en = {
  ...
  register: {
    ...
    referralBadge: "Referral invite",
    joinTitle: "Join UnikTrades",
    joinSubtitle: "You were invited — complete signup below",
    ...
    referralApplied: "Referral code {code} applied — you were invited by a friend.",
    ...
    needReferral: "A referral invite is required to join",
