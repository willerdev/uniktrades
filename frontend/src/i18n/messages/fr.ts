export const fr = {
  ...
  register: {
    ...
    referralBadge: "Invitation de parrainage",
    joinTitle: "Rejoindre UnikTrades",
    joinSubtitle: "Vous avez été invité — finalisez l’inscription ci-dessous",
    ...
    referralApplied: "Code de parrainage {code} appliqué — vous avez été invité.",
    ...
    needReferral: "Une invitation de parrainage est requise pour rejoindre",
