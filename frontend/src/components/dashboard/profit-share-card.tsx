        ...
        {!status.active ? (
          ...
          <>
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <div>
                <p className="text-[10px] uppercase tracking-wide text-muted">Lifetime</p>
                <p className="text-lg font-semibold text-emerald-400">
                  {formatCurrency(status.lifetimeEarned)}
                </p>
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-wide text-muted">Withdraw at</p>
                <p className="text-lg font-semibold text-foreground">
                  {formatCurrency(status.withdrawThreshold)}
                </p>
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-wide text-muted">Your split</p>
            ...
            {status.canWithdraw && (
              <div className="rounded-lg border border-[var(--color-border)] bg-foreground/[0.04] p-3">
